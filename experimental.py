...
points_amount = 7000 # точек на контуре
...
def get_nodes(cont, need_alphas=False, method = 'secant'):
    # Основной алгоритм
    x_alphas = []
    possible_nodes = []
    coefficients = []
...
if __name__ == "__main__":
    ...
    for z in ['secant', 'mnewton','halley', 'muller', 'illinois', 'pegasus', 'anderson' ,'ridder', 'anewton' ,'bisect']:
        ans = get_nodes(countour, method=z)
